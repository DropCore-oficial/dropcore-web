...
/** Logo oficial (Simple Icons, CC0) — glifo original em vez de desenho aproximado à mão. */
        ...
        <div className="flex flex-col gap-8 sm:flex-row sm:flex-wrap sm:justify-between sm:gap-x-10 sm:gap-y-8">
          ...
          <div className="min-w-0 sm:shrink-0">
            ...
            <div className="mt-2 flex items-center gap-1.5">
              <a href={landingSalesWhatsapp()} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className={SOCIAL_ICON_CLASS}>
                <IconWhatsApp className="h-4 w-4" />
              </a>
              <a href={`mailto:${LANDING_SALES_EMAIL}`} aria-label="E-mail" className={SOCIAL_ICON_CLASS}>
