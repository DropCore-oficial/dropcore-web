  ...
  return (
    <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-row sm:flex-wrap sm:gap-2">
      <Link
        ...
        className="inline-flex min-w-0 items-center justify-center rounded-md bg-emerald-600 px-2.5 py-1.5 text-center text-[11px] font-semibold leading-tight text-white shadow-sm transition hover:bg-emerald-700 active:bg-emerald-900 sm:flex-initial"
      >
        Voltar à conexão
      </Link>
      <Link
        href="/seller/produtos#erp-catalogo-sku"
        className="inline-flex min-w-0 items-center justify-center rounded-md border border-emerald-500/35 bg-emerald-50 px-2.5 py-1.5 text-center text-[11px] font-semibold leading-tight text-emerald-900 transition hover:bg-emerald-100 dark:border-emerald-400/30 dark:bg-emerald-950/50 dark:text-emerald-300 dark:hover:bg-emerald-900/40 sm:flex-initial"
      >
        Catálogo / SKU
      </Link>
    </div>
