...
export const AVISO_DADOS_FORNECEDOR_SELLER =
  "Estes dados identificam o armazém para pedidos e suporte na DropCore. Use-os apenas nesse contexto; não copie para fins externos nem partilhe fora da operação acordada com a organização.";
